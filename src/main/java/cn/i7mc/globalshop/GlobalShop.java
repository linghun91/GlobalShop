...
public class GlobalShop extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (!setupEconomy()) {
            ...
            console.sendMessage(ChatColor.DARK_AQUA + "[GlobalShop] " + ChatColor.DARK_RED + "未找到" + ChatColor.GOLD + "Vault" + ChatColor.DARK_RED + "插件或基于Vault的经济插件例如Essentials，插件将无法正常工作！");
