...
public class MessageManager {
     ...
     * @return F键查看卖家商品提示
     */
    public String getAuctionFKeySellerTip() {
        return messages.getString("auction_item.f_key_tip", "§7F键: §f查看该卖家的所有商品");
    }
    ...
    /**
     * 获取F键查看卖家商品的提示消息
     * @return F键查看卖家商品的提示消息
     */
    public String getFKeySellerSearchMessage() {
        return messages.getString("messages.f_key_seller_search", "§a正在查看卖家 §e%seller% §a的所有商品...");
    }
